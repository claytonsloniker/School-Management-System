...
public class EditTeacherDialog extends JDialog {
    ...
    private boolean teacherUpdated = false;
    private Teacher updatedTeacher = null;
    private Teacher originalTeacher;
    
    public EditTeacherDialog(JFrame parent, Teacher teacher) {
        super(parent, "Edit Teacher", true);
    ...
    private JPanel createFormPanel() {
        ...
        teacherIDField.setEditable(false); // Make ID field read-only
    ...
    private void populateFields() {
        teacherIDField.setText(originalTeacher.getId());
        firstNameField.setText(originalTeacher.getFirstName());
        lastNameField.setText(originalTeacher.getLastName());
        emailField.setText(originalTeacher.getEmail());
        statusComboBox.setSelectedItem(originalTeacher.getStatus());
    ...
    private void saveUpdatedTeacher() {
        ...
        // Create updated teacher with either the new password or the original one
        String password;
        if (changePasswordCheckBox.isSelected()) {
            ...
            password = originalTeacher.getPassword(); // Keep the original hashed password
        }
        
        // Create updated teacher
        updatedTeacher = new Teacher(id, firstName, lastName, email, password, status);
        teacherUpdated = true;
    ...
    /**
     * Show an information dialog with the teacher's new password
    ...
    private void showPasswordUpdatedDialog(String firstName, String lastName, String password) {
        ...
        infoArea.setText(
            ...
            "Please provide this password to the teacher."
        );
    ...
    /**
     * Check if a teacher was updated
     * @return true if a teacher was updated, false otherwise
     */
    public boolean isTeacherUpdated() {
        return teacherUpdated;
    }
    
    /**
     * Get the updated teacher
     * @return the updated teacher, or null if no teacher was updated
     */
